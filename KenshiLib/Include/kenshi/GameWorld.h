...
public:
    ...
    SimpleTimeStamper();// public RVA = 0x829450
    SimpleTimeStamper* _CONSTRUCTOR();// public RVA = 0x829450
    double getTime(double _lastStamp);// public RVA = 0x3806B0
    double stampTime();// public RVA = 0x25B020
    ~SimpleTimeStamper();// public RVA = 0x8293C0
    void _DESTRUCTOR();// public RVA = 0x8293C0
