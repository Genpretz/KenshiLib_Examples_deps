...
public:
    ...
    virtual CharacterHuman* isHuman() override;// public RVA = 0x5E5240 vtable offset = 0x0
    CharacterHuman* _NV_isHuman();// public RVA = 0x5E5240 vtable offset = 0x0
    virtual bool drawWeapon(Item* item, std::string lastSection) override;// public RVA = 0x5DB800 vtable offset = 0x0
    bool _NV_drawWeapon(Item* item, std::string lastSection);// public RVA = 0x5DB800 vtable offset = 0x0
    virtual void sheatheWeapon() override;// public RVA = 0x5CC0A0 vtable offset = 0x0
    void _NV_sheatheWeapon();// public RVA = 0x5CC0A0 vtable offset = 0x0
    virtual Weapon* getCurrentWeapon() override;// public RVA = 0x5C9010 vtable offset = 0x0
    Weapon* _NV_getCurrentWeapon();// public RVA = 0x5C9010 vtable offset = 0x0
    virtual Weapon* getThePreferredWeapon() override;// public RVA = 0x5C9020 vtable offset = 0x0
    Weapon* _NV_getThePreferredWeapon();// public RVA = 0x5C9020 vtable offset = 0x0
    virtual Crossbow* getRangedWeapon() override;// public RVA = 0x5C83A0 vtable offset = 0x0
    Crossbow* _NV_getRangedWeapon();// public RVA = 0x5C83A0 vtable offset = 0x0
    virtual GameSaveState serialise(GameDataContainer* container, GameData* refList, PosRotPair* offsetPosToSubtract) override;// public RVA = 0x628E20 vtable offset = 0x0
    ...
    virtual void loadFromSerialise(GameSaveState* state) override;// public RVA = 0x6289D0 vtable offset = 0x0
    void _NV_loadFromSerialise(GameSaveState* state);// public RVA = 0x6289D0 vtable offset = 0x0
    virtual bool giveBirth(GameDataCopyStandalone* _appearance, const Ogre::Vector3& _pos, const Ogre::Quaternion& _rot, GameSaveState* state, ActivePlatoon* tempplatoonptr, Faction* _faction) override;// public RVA = 0x62E7F0 vtable offset = 0x0
    ...
    virtual bool setupInventorySections(GameSaveState* state) override;// public RVA = 0x62BD60 vtable offset = 0x0
    bool _NV_setupInventorySections(GameSaveState* state);// public RVA = 0x62BD60 vtable offset = 0x0
    virtual void validateInventorySections() override;// public RVA = 0x621170 vtable offset = 0x0
    void _NV_validateInventorySections();// public RVA = 0x621170 vtable offset = 0x0
    virtual void setupAudio() override;// public RVA = 0x6296D0 vtable offset = 0x0
    void _NV_setupAudio();// public RVA = 0x6296D0 vtable offset = 0x0
    void shaveHead(bool on);// public RVA = 0x5B1D20
    virtual bool isHeadShaven() const override;// public RVA = 0x5B1D40 vtable offset = 0x0
    bool _NV_isHeadShaven() const;// public RVA = 0x5B1D40 vtable offset = 0x0
    virtual void createAnimationClass() override;// protected RVA = 0x5C8EF0 vtable offset = 0x0
    void _NV_createAnimationClass();// protected RVA = 0x5C8EF0 vtable offset = 0x0
    virtual void dropItem(RootObject* itembase) override;// protected RVA = 0x5C9FC0 vtable offset = 0x0
    ...
    virtual void unequipItem(const std::string& section, Item* item) override;// protected RVA = 0x5DBDE0 vtable offset = 0x0
    void _NV_unequipItem(const std::string& section, Item* item);// protected RVA = 0x5DBDE0 vtable offset = 0x0
    virtual void weatherUpdate(float time) override;// protected RVA = 0x5CF010 vtable offset = 0x0
    ...
    virtual void postRagdollCallback(bool on, RagdollPart::Enum part) override;// protected RVA = 0x5CBAB0 vtable offset = 0x0
    void _NV_postRagdollCallback(bool on, RagdollPart::Enum part);// protected RVA = 0x5CBAB0 vtable offset = 0x0
    virtual void reCalculateNaturalWeapon() override;// protected RVA = 0x62A570 vtable offset = 0x0
