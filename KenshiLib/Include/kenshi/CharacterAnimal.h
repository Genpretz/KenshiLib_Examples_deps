...
public:
    ...
    virtual CharacterAnimal* isAnimal() override;// public RVA = 0x5E17D0 vtable offset = 0x0
    CharacterAnimal* _NV_isAnimal();// public RVA = 0x5E17D0 vtable offset = 0x0
    virtual void createAnimationClass() override;// public RVA = 0x5E84B0 vtable offset = 0x0
    void _NV_createAnimationClass();// public RVA = 0x5E84B0 vtable offset = 0x0
    // no_addr bool preventRagdollMode();// public
    virtual bool drawWeapon(Item* _a1, std::string lastSlot) override;// public RVA = 0x5E5150 vtable offset = 0x0
    bool _NV_drawWeapon(Item* _a1, std::string lastSlot);// public RVA = 0x5E5150 vtable offset = 0x0
    virtual void sheatheWeapon() override;// public RVA = 0x5E17E0 vtable offset = 0x0
    void _NV_sheatheWeapon();// public RVA = 0x5E17E0 vtable offset = 0x0
    virtual Weapon* getCurrentWeapon() override;// public RVA = 0x5E17F0 vtable offset = 0x0
    Weapon* _NV_getCurrentWeapon();// public RVA = 0x5E17F0 vtable offset = 0x0
    virtual Weapon* getThePreferredWeapon() override;// public RVA = 0x5E1800 vtable offset = 0x0
    Weapon* _NV_getThePreferredWeapon();// public RVA = 0x5E1800 vtable offset = 0x0
    virtual InventoryLayout* createInventoryLayout() override;// public RVA = 0x5CBEB0 vtable offset = 0x0
    InventoryLayout* _NV_createInventoryLayout();// public RVA = 0x5CBEB0 vtable offset = 0x0
    virtual bool giveBirth(GameDataCopyStandalone* appearance, const Ogre::Vector3& position, const Ogre::Quaternion& rotation, GameSaveState* state, ActivePlatoon* tempplatoonptr, Faction* _faction) override;// public RVA = 0x62E880 vtable offset = 0x0
    ...
    virtual bool setupInventorySections(GameSaveState* state) override;// public RVA = 0x6299B0 vtable offset = 0x0
    bool _NV_setupInventorySections(GameSaveState* state);// public RVA = 0x6299B0 vtable offset = 0x0
    virtual void setupAudio() override;// public RVA = 0x629870 vtable offset = 0x0
    void _NV_setupAudio();// public RVA = 0x629870 vtable offset = 0x0
    virtual void periodicUpdate() override;// public RVA = 0x5CD780 vtable offset = 0x0
    void _NV_periodicUpdate();// public RVA = 0x5CD780 vtable offset = 0x0
    virtual void setAge(float zeroToOne) override;// public RVA = 0x5E1810 vtable offset = 0x0
    void _NV_setAge(float zeroToOne);// public RVA = 0x5E1810 vtable offset = 0x0
    virtual float getAge() const override;// public RVA = 0x5E1820 vtable offset = 0x0
    float _NV_getAge() const;// public RVA = 0x5E1820 vtable offset = 0x0
    virtual float getAgeInverse() const override;// public RVA = 0x5E1850 vtable offset = 0x0
    float _NV_getAgeInverse() const;// public RVA = 0x5E1850 vtable offset = 0x0
    virtual float getAge0to1() const override;// public RVA = 0x5E1890 vtable offset = 0x0
    float _NV_getAge0to1() const;// public RVA = 0x5E1890 vtable offset = 0x0
    virtual unsigned int getDefaultTaskRepertoireEnum() const override;// public RVA = 0x5E18A0 vtable offset = 0x0
    unsigned int _NV_getDefaultTaskRepertoireEnum() const;// public RVA = 0x5E18A0 vtable offset = 0x0
    virtual bool canGoIndoors(Building* b) const override;// public RVA = 0x5C7A50 vtable offset = 0x0
    ...
    virtual float getHPMultiplier() const override;// public RVA = 0x5E18D0 vtable offset = 0x0
    ...
    virtual void foodUpdate() override;// public RVA = 0x5DBED0 vtable offset = 0x0
    ...
    virtual void init() override;// protected RVA = 0x622EE0 vtable offset = 0x0
    void _NV_init();// protected RVA = 0x622EE0 vtable offset = 0x0
    virtual void dropItem(RootObject* itembase) override;// protected RVA = 0x5C9D20 vtable offset = 0x0
